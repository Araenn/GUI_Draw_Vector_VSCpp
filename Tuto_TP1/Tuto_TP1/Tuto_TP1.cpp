...
// Tuto_TP1.cpp : définit les comportements de classe de l'application.
//
...
BEGIN_MESSAGE_MAP(CTutoTP1App, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CTutoTP1App::OnAppAbout)
...
// Construction de CTutoTP1App

CTutoTP1App::CTutoTP1App() noexcept
{
	...
	SetAppID(_T("TutoTP1.AppID.NoVersion"));

	// TODO: ajoutez ici du code de construction,
	// Placez toutes les initialisations significatives dans InitInstance
}

// Le seul et unique objet CTutoTP1App

CTutoTP1App theApp;


// Initialisation de CTutoTP1App

BOOL CTutoTP1App::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_TutoTP1TYPE,
		RUNTIME_CLASS(CTutoTP1Doc),
		RUNTIME_CLASS(CChildFrame), // frame enfant MDI personnalisé
		RUNTIME_CLASS(CTutoTP1View));
	if (!pDocTemplate)
		return FALSE;
...
// gestionnaires de messages de CTutoTP1App
...
void CTutoTP1App::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// méthodes de chargement/d'enregistrement de la personnalisation de CTutoTP1App

void CTutoTP1App::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CTutoTP1App::LoadCustomState()
{
}

void CTutoTP1App::SaveCustomState()
{
}
