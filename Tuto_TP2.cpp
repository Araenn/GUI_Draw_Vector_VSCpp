...
// Tuto_TP2.cpp : définit les comportements de classe de l'application.
//
...
BEGIN_MESSAGE_MAP(CTutoTP2App, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CTutoTP2App::OnAppAbout)
...
// Construction de CTutoTP2App

CTutoTP2App::CTutoTP2App() noexcept
{
	...
	SetAppID(_T("TutoTP2.AppID.NoVersion"));

	// TODO: ajoutez ici du code de construction,
	// Placez toutes les initialisations significatives dans InitInstance
}

// Le seul et unique objet CTutoTP2App

CTutoTP2App theApp;


// Initialisation de CTutoTP2App

BOOL CTutoTP2App::InitInstance()
{
...
// gestionnaires de messages de CTutoTP2App
...
void CTutoTP2App::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// méthodes de chargement/d'enregistrement de la personnalisation de CTutoTP2App

void CTutoTP2App::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CTutoTP2App::LoadCustomState()
{
}

void CTutoTP2App::SaveCustomState()
{
}
